...
from existing_methods.lerm_main.src.optim.algorithms import StochasticSubgradientMethod


def SGDmethod(X,y,weight_function,loss, l2_reg=None,l1_reg=None,lossB=None,
              max_iter = 20,batch_size=64, lr = 0.01,train_loss=None, test_loss=None, verbose=True,args=None):
    y = y.copy()
    ...
    optimizer = StochasticSubgradientMethod(train_objective, lr=lr, batch_size=batch_size, epoch_len=100)
