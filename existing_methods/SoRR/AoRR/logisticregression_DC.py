...
class LogisticRegression_TOPK_DC:
    def __init__(self, lr=0.01, num_iter=100, inner_iter=1000, fit_intercept=True, verbose=True, k_value=5, k2_value = 4, seed =1234, dataname='real', Model_name='LogisticRegression',train_loss=None):
        self.lr = lr
